...
namespace SampleClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\pawel\Documents\Projekty\.NET\Laboratorium4\test.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("sentiment", "sentiment")
                                      .Append(mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("Time of Tweet", "Time of Tweet"), new InputOutputColumnPair("Age of User", "Age of User") }))
                                      .Append(mlContext.Transforms.Categorical.OneHotHashEncoding(new[] { new InputOutputColumnPair("Country", "Country") }))
                                      .Append(mlContext.Transforms.Text.FeaturizeText("text_tf", "text"))
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "Time of Tweet", "Age of User", "Country", "text_tf", "Population -2020", "Land Area (Km�)", "Density (P/Km�)" }))
